...
(function () {
  ...
  + '#msc-bubble{position:fixed;right:20px;bottom:20px;z-index:9000;width:62px;height:62px;border-radius:50%;background:linear-gradient(135deg,#1d1d5c,#403DD8);border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;transition:transform .2s cubic-bezier(.34,1.56,.64,1);box-shadow:0 10px 34px rgba(64,61,216,.5)}'
  + '#msc-bubble::before{content:"";position:absolute;inset:-3px;border-radius:50%;background:conic-gradient(from 0deg,#403DD8,#81AAFB,#fff,#403DD8);animation:mscSpin 4s linear infinite;z-index:-1;filter:blur(5px);opacity:.9}'
